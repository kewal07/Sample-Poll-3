...
(function(d, c) {
    ...
    var _impAd = document.querySelector('#'+CONTAINER_ID);
        ...
        var f = c.reviveAsync[a] = {
            ...
            start: function() {
                var e = function() {
                    try {
                        if (!f.done) {
                            ...
                            //_impAd.removeEventListener("load", e, false);
                            f.done = true;
                            f.apply(f.detect())
                        }
                    } catch (g) {
                ...
                if (d.readyState === "loading") {
                    ...
                    //_impAd.addEventListener("load", e, false)
                    e();
                }
            },
            ajax: function(e, g) {
            ...
            apply: function(g) {
                if (g.zones.length) {
                    var e = d.location.protocol == "http:" ? "http://wtf2.forkcdn.com/www/delivery/asyncspc.php" : "https://wtf2.forkcdn.com/www/delivery/asyncspc.php";
